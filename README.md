...
<object data="https://github.com/TomatenMarc/NER-CTI/blob/introduce/spacy-project-structure/graphics/NER-Example.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="https://github.com/TomatenMarc/NER-CTI/blob/introduce/spacy-project-structure/graphics/NER-Example.pdf">
        <p>The aim of NER is to extract entities form unstructured text and thus to extract only the most basic aspects of a document.</p>
    </embed>
</object>

<iframe src="https://github.com/TomatenMarc/NER-CTI/blob/introduce/spacy-project-structure/graphics/NER-Example.pdf" width="100%" height="500px"></iframe>
